...
python3Packages.buildPythonApplication rec {
  ...
  disabledTests = [
    ...
    # gitSetupHook is not yet a thing
    "tests.doctests.test_GitVfs.test_binary_read"
    "tests.doctests.test_GitVfs.test_content_manager"
    "tests.doctests.test_GitVfs.test_read"
  ]
